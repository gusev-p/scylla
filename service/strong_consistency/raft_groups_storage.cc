...
std::vector<index_and_replay_position> raft_groups_storage::get_replay_position_handles_for(const raft::log_entry_ptr_list& entries) {
    return _commitlog_persistence.get_replay_position_handles_for(entries);
}
